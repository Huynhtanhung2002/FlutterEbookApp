...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    BorrowedBooksRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const BorrowedBooksScreen(),
      );
    },
...
/// generated route for
/// [BorrowedBooksScreen]
class BorrowedBooksRoute extends PageRouteInfo<void> {
  const BorrowedBooksRoute({List<PageRouteInfo>? children})
      : super(
      BorrowedBooksRoute.name,
          initialChildren: children,
        );

  static const String name = 'BorrowedBooksRoute';
