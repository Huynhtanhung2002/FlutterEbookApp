    ...
    return InkWell(
      onTap: () {
        ...
        if (context.isLargeScreen && isHomeTab) {
          context.router.replace(route); // Thay thế route hiện tại bằng route chi tiết sách cho màn hình lớn
        } else {
          // Đẩy route chi tiết sách cho màn hình nhỏ hoặc khi không ở trong tab trang chính
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            // Hiển thị tiêu đề sách, tác giả và tóm tắt
            Flexible(
              child: Column(
